                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-end">
                            ...
                            <ul class="user-login">
                                <li>
                                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout').submit()">{{ __('Sing Out') }}</a>
                                </li>
                            ...
                            <ul class="sub-category">
                                ...
                                <li><a href="product-grids.html">{{ $category->name }} <i
                                    ...
                                    <ul class="inner-sub-category">
                                        <li><a href="product-grids.html">{{ $category->parent->name}}</a></li>
                                    </ul>
                                    @endif
